 ...
 * @Last Modified time: 2023-05-17 15:31:21
 */
import { getCatesian3FromPX } from '../thirdPart/Coordinate';
import { lockingMap, newSessionid, calculateRectanglePoints, computeAssemblePoints } from '../thirdPart/plotCommon';
...
const EditAssemble = (
  ...
  let currentPickPolygon: any = undefined; //当前选择的要移动的集结地
  // 左键摁下事件
