 ...
 * @Last Modified time: 2023-05-18 17:13:37
 */
import { getCatesian3FromPX } from '../thirdPart/Coordinate';
import { lockingMap, newSessionid, calculateBowPoints } from '../thirdPart/plotCommon';
...
const EditBow = (
  ...
  let currentPickFormation: any = undefined; //当前选择的要移动的弓形对象
  // 左键摁下事件
