...
export default () => {
  ...
  viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(137.832152, 7.081732, 11790741.98),
    orientation: {
      heading: Cesium.Math.toRadians(358.39703070681463),
      pitch: Cesium.Math.toRadians(-85.08638797675535),
      roll: Cesium.Math.toRadians(1.838965842232041)
    }
  });
