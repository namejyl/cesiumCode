...
import { lockingMap, newSessionid, calculateRectanglePoints } from '../thirdPart/plotCommon';
...
const EditRectangle = (
  ...
  let dynamicRectangle = new Cesium.CallbackProperty(function () {
    return Cesium.Rectangle.fromCartesianArray(calculateRectanglePoints(updatePos));
  }, false);
  if (editItem) {
