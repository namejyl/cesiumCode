 ...
 */
import { lockingMap, newSessionid, getAttackArrowPoints } from '../thirdPart/plotCommon';
      ...
      if (index > 1) {
        let centerPoint = viewer.entities.add({
          ...
          position: new Cesium.CallbackProperty(() => {
            let startPos = index === 2 ? Cesium.Cartesian3.midpoint(updatePos[0], updatePos[1], new Cesium.Cartesian3()) : updatePos[index - 1];
